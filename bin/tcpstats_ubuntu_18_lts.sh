...
# Date:                 22/08/2016
# Author:               Long Chen
# modified by:          Daniele Giordano - 19/03/2022
# Description:          A script to send TCP stats to zabbix server by using zabbix sender, compatible with Ubuntu linux 18 LTS
